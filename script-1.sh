...
#SBATCH -o sherlock-4-1l-512n-1000e-128bs-02do.out      # File to which STDOUT will be written
#SBATCH -e sherlock-4-1l-512n-1000e-128bs-02do.err      # File to which STDERR will be written
...
filename="4-mod"
weightfile="sherlock-4-1l-512n-1000e-128bs-02do"
layers="1"
nodes="512"
epochs="1000"
batchsize="128"
