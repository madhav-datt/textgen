...
#SBATCH -o sherlock-4-1l-1024n-1000e-256-02do.out      # File to which STDOUT will be written
#SBATCH -e sherlock-4-1l-1024n-1000e-256-02do.err      # File to which STDERR will be written
...
filename="4-mod"
weightfile="sherlock-4-1l-1024n-1000e-256-02do"
layers="1"
nodes="1024"
epochs="1000"
batchsize="256"
