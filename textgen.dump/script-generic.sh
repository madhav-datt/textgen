...
#SBATCH -o sherlock-4-4l-128n-1000e-64bs-01do.out      # File to which STDOUT will be written
#SBATCH -e sherlock-4-4l-128n-1000e-64bs-01do.err      # File to which STDERR will be written
