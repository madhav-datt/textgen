...
#     :rtype: float
#     """
#     return modified_bleu([references], [hypothesis], weights, smoothing_function)


def modified_bleu(list_of_references, hypotheses, weights=(0.25, 0.25, 0.25, 0.25),
                  smoothing_function=None):
    """
    ...
    return math.exp(math.fsum(s))  # * bp
...
#         0.4118...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method0)) # doctest:
# +ELLIPSIS
#         0.4118...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method1)) # doctest:
# +ELLIPSIS
#         0.4118...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method2)) # doctest:
# +ELLIPSIS
#         0.4489...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method3)) # doctest:
# +ELLIPSIS
#         0.4118...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method4)) # doctest:
# +ELLIPSIS
#         0.4118...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method5)) # doctest:
#  +ELLIPSIS
#         0.4905...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method6)) # doctest:
# +ELLIPSIS
#         0.4135...
#         >>> print (sentence_bleu([reference1], hypothesis1, smoothing_function=chencherry.method7)) # doctest:
# +ELLIPSIS
#         0.4905...
