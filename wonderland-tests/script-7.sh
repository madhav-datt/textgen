...
#SBATCH -o sherlock-4-4l-64n-1000e-64bs-02do.out      # File to which STDOUT will be written
#SBATCH -e sherlock-4-4l-64n-1000e-64bs-02do.err      # File to which STDERR will be written
...
filename="4-mod"
weightfile="sherlock-4-4l-64n-1000e-64bs-02do"
layers="4"
nodes="64"
epochs="1000"
batchsize="64"
