...
#SBATCH -o sherlock-4-3l-256n-1000e-128bs-02do.out      # File to which STDOUT will be written
#SBATCH -e sherlock-4-3l-256n-1000e-128bs-02do.err      # File to which STDERR will be written
...
filename="4-mod"
weightfile="sherlock-4-3l-256n-1000e-128bs-02do"
layers="3"
nodes="256"
epochs="1000"
batchsize="128"
